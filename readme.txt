...
This WCA contains the videoplayer wcb.
...
The following features are new in 1.0:

1. Configurable videoplayer based on JWPlayer
...
The WCA contains the following files and folders (of which folders are surrounded by < and >):
  ...
  <bin>                             |  The compiled WCBs
    videoplayer_1.0.1.jar           |  Videoplayer wcb
...
---------------------------------------------------------------------------------------------------
No additional GX WebManager user desktop requirements apply to this WCA. For a full list of GX 
WebManager user desktop requirements, see the GX WebManager user desktop requirements of the
WebManager plaform.
...
-6- INSTALLATION
===================================================================================================
There are no additional instructions to install this WCB but the regular ones that apply to all
WCBs.
...
-9- CONTACT INFORMATION
===================================================================================================
For any questions or remarks, contact GMIC at gerhard.messelink@gmail.com          
